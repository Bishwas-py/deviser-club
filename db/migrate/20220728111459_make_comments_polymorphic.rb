class MakeCommentsPolymorphic < ActiveRecord::Migration[7.0]
  def change
    ...
    add_index :comments, [:user_id, :commentable_id, :commentable_type], unique: true, name: 'index_comments_on_user_id_and_comable_id_and_comable_type'  # re-add new uniqueness constraint, 4th
